  ...
  return (
    ...
    <div className="pIntro">
      <h3>A Brief Introduction to Parries</h3>
        <p>
          The parry system was first introduced in Street Fighter III: 3rd Strike. A parry allows players to challenge their
          opponent's incoming attack, negate any incoming chip damage sustained by blocking, and potentially deliver a counterattack that is otherwise impossible to do while blocking.
          ...
          <br/> <br/>
          The most famous example of this is the EVO moment 37 clip, where Daigo Umehara (Ken) manages to parry an incoming
          15 hit super art move from Justin Wong (Chun Li).
    ...
    <div className="pMechanics">
      ...
      <p>
        ...
        <br/>Parried projectiles and the parrier will be frozen in place but the attacker will not be frozen.
        <br/>
    ...
    <div className="pLearn">
      <h3>Learning How to Parry</h3>
        <p>
          ...
          <br/>
          Multi-hit moves can also be useful, but can have varying active hitbox frames that can complicate the parrying rhythm (i.e. Chun-Li's Hyakuretsu Kyaku) or additional hits based on the variant of the special attack used.
          <br/><br/>
        </p>
    </div>
    <div className="pLook">
